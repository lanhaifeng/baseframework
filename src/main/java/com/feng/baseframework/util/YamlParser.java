 ...
 * @author lanhaifeng
 * @version v2.0.0
 * @apiNote 时间:2023/3/31 10:59创建:YamlParser
 * @since v2.0.0
 */
public class YamlParser {
    ...
    public static Map<String, Object> getMultilayerMap(Map<String, Object> source) {
    ...
    private static void buildMultilayerMap(Map<String, Object> parent, String path,Object value) {
        ...
        if (key.endsWith("]")) {
            ...
            if (keys.length == 1) {
                ...
                Map<String, Object> child = bulidChlidMap(parent, key);;
